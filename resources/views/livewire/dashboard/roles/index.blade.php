<div>
        ...
        <div class="card-header">
            ...
            <div class="row g-2 align-items-end">
                <div class="col-md-4">
                    ...
                    <input wire:model.live.debounce.400ms="search" type="text" class="form-control" placeholder="ابحث بالاسم أو المفتاح">
                </div>
                <div class="col-md-2">
                    ...
                    <tbody>
                        @forelse($roles as $role)
                            <tr wire:key="role-{{ $role->id }}">
                                <td class="fw-semibold"><span class="badge  {{ $role->color }}">{{ $role->name ?? '—' }}</span></td>
                                <td>
    ...
    {{-- Role Form Modal --}}
    <div class="modal fade" id="roleFormModal" tabindex="-1" aria-labelledby="roleFormModalLabel" aria-hidden="true" wire:ignore.self>
